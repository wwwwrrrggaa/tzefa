...
if __name__ == '__main__':
    ...
    @dataclass(frozen=True)
    class DatasetConfig:
        DATA_ROOT: str = r'C:\DataSets\Words'
    ...
    train_dataset = CustomOCRDataset(
        root_dir=os.path.join(DatasetConfig.DATA_ROOT, r'C:\DataSets\Words'),
        processor=processor,
        datasetpath=r"C:\DataSets\textfiles\train.txt"
    )
    valid_dataset = CustomOCRDataset(
        root_dir=os.path.join(r'C:\DataSets\Words3', r'C:\DataSets\Words3'),
        processor=processor,
        datasetpath=r"C:\DataSets\textfiles\valid.txt"
    )
